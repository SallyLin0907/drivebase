...
public class Constants {
  ...
  public static final class DriveBaseConstants {
    ...
    public static final int kBackLeftCanCoder = 2;
    public static final int kBackRightCanCoder = 3;

    

    // turning encoder magnet offset value
    public static final double kFrontLeftCanCoderMagOffset = -0.029541015625;
    public static final double kFrontRightCanCoderMagOffset = 0.089111328125;
    public static final double kBackLeftCanCoderMagOffset = 0.131103515625;
    public static final double kBackRightCanCoderMagOffset = -0.81567384375;
